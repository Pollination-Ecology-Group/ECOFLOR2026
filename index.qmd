...
📞 [Contact](#contact) via [WhatsApp group chat](https://chat.whatsapp.com/KCycNVzqLEm1orgBQGjrQ2?mode=ems_copy_t), [Discord](https://discord.gg/yCYCSK87) or [email](#contact)
:::
:::::
...
[Registration form here](https://docs.google.com/forms/d/1vKq5S5Cm2qB0_3n6bN_rPXYxbc_ndYYX6-_Sn8utHqg/viewform?edit_requested=true){.btn .btn-danger}
:::
...
Workshops will occur in the venue, [Centre Cívic Ferreries](https://maps.app.goo.gl/mSEFoTJQ9mBsUPG3A). One workshop will focus on [Nesting traps for cavity-nesting bees and wasps in ecological studies: biology, ecology, materials and methods] and second one on [Emerging priorities in plant-pollinator systems research in Mediterranean ecosystems]. To participate in the workshops, **you must be registered**. Further information about place and attendance will be sent to all **registered** participants. For more information, see the [Workshops].
:::
:::::
...
::: {style="text-align: justify;"}
-   [Workshops]:
    -   10:00 - 13:00 [Nesting traps for cavity-nesting bees and wasps in ecological studies: biology, ecology, materials and methods]
    -   15:00 - 18:00 [Emerging priorities in plant-pollinator systems research in Mediterranean ecosystems]
:::
...
-   15:00 - 16:30 Oral presentations
-   16:30 - 18:00 Oral presentations
-   18-19 Coffee goodbey + Poster session
...
::: {#keynote}
### Keynote speakers {style="text-align: center;"}
...
::::::::: columns
::: {.column width="40%"}
![](images/nests.png){fig-align="left" width="400"}
:::
...
:::: {.column width="60%"}
#### Emerging priorities in plant-pollinator systems research in Mediterranean ecosystems
...
::: {.column width="40%"}
![](images/mediteran.png){fig-align="right" width="400"}
:::
:::::::::
:::::::::::
...
In the first part of the field trip, we will visit the area affected by the wildfire. In the first part of the visit, we will learn about 1) the ecosystems and conservation strategies present in the Ports Natural Park; 2) how the wildfire started, developed, and its consequences in the affected area; and 3) the current status of forests and fire regimes in this region. We will also discuss several topics of ecological relevance for plant-pollinator systems in areas affected by wildfires, including ongoing projects and studies.
:::
...
Another fantastic and genuine option is to have lunch in [Mercat de Tortosa](https://share.google/GI6Nx5BjW5Z5VXps4), a genuine Mediterranean market where fresh fruit, vegetables, fish and meat, mingle with quick and delicious cooking in bar stands (Market cuisine).

If you go there, you simply HAVE TO go to [Bar Ester](https://share.google/IO2bF2TtQjZKNY2v5). They are simply the best. Try the traditional “abadejo” (cod), eels, cap-i-pota, artichoke omelette, and so on (everything local).
...
\
**Organisation committee**: [Carlos Hernández-Castellano], [Néstor Pérez-Méndez], [Jordi Margalef-Marrassé], [Alice Casiraghi], [Alice Casiraghi], [Marina Aguilar], [Júlia Batlle-Benaiges], [JJúlia Coromina], [Nil Guerrero]

![](images/wildlifelab.png){fig-align="center" width="300"}
...
::: {style="text-align: center;"}
[✉️](jucoromina8@gmail.com) [![](images/linkedin.png){width="25"}](https://www.linkedin.com/in/j%C3%BAlia-coromina-javier-320374238/)
:::
:::::
:::::::
...
::: {style="text-align: center;"}
✉️ [![](images/scholar.png){width="25"}](https://scholar.google.com/citations?user=Os21VVYAAAAJ&hl=ca)
:::
:::::
:::::::
