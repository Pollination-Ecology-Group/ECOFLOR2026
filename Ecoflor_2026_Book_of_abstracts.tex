...
\textbf{Authors:} Patricia Roca-Villanueva, Ana García Muñoz, A.Jesús
Muñoz-Pajares, Mohamed Abdelaziz, Xavier Picó.
...
\subsubsection{In cross-pollinated systems lacking seed-dispersal
mechanisms, pollinator activity
strongly}\label{in-cross-pollinated-systems-lacking-seed-dispersal-mechanisms-pollinator-activity-strongly}

determines the spatial arrangement of individuals within a population.
Consequently, neighbouring plants often exhibit greater genetic
similarity than expected by chance, increasing the likelihood of mating
among relatives. Such inbreeding can reduce fitness due to the
expression of recessive deleterious alleles associated with higher
genetic homogeneity between pollen donor and receptor. We used
Moricandia moricandioides, an allogamous, hermaphroditic and
self-incompatible species, to (i) characterize the degree of
self-incompatibility, (ii) evaluate the costs of reproduction between
related individuals, and (iii) assess how the parental neighbourhood
influences offspring performance. We worked with a parental generation
with known spatial genetic structure and a second generation of 320
individuals with known relatedness. A total of 820 directed controlled
crossess were performed, varying the genetic distance between donors and
receptors and accounting for parental neighbourhood. We assessed the
success of forced self-pollination and cross treatments by measuring
fruit set, seed number and seed set. Our results show that forced
self-pollination succeeded more often than expected for a
self-incompatible system, and that cross success increased with genetic
distance between parents. These patterns suggest a partially relaxed
self-incompatibility system that may promote reproduction within
familial patches, while favouring genetically more distant crosses.
...
canopy of a tropical montane
forest}\label{the-importance-of-aiming-high-bee-diversity-in-the-canopy-of-a-tropical-montane-forest}

\textbf{Presenter:} Claudia Vigano

\textbf{Affiliation:} Freiburg

\textbf{Authors:} Claudia Viganò, Pedro Alonso-Alonso, Júlia
Batlle-Benaiges, Pedro Jordano, Alessandro Mainardi, Irene Mendoza,
Claus Rasmussen, Richar Samaniego, Juan Pablo Uchuari, Katrin Heer
...
\section{Plant Traits, Floral Biology, and Pollination
Mechanisms}\label{plant-traits-floral-biology-and-pollination-mechanisms}

\subsubsection{NA}\label{na}

\textbf{Presenter:} Afonso Petronilho

\textbf{Affiliation:} University of Coimbra AND University of Cadiz

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-1}

\textbf{Presenter:} Cristina Montoya de Haro

\textbf{Affiliation:} University of Granada

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-2}

\textbf{Presenter:} Ellen De Vrieze

\textbf{Affiliation:} Ghent University

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-3}

\textbf{Presenter:} Eva Matoušková

\textbf{Affiliation:} Department of Botany, Charles University, Prague

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-4}

\textbf{Presenter:} Felipe Torres-Vanegas

\textbf{Affiliation:} Lund University

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-5}

\textbf{Presenter:} Giovanna Aronne

\textbf{Affiliation:} University of Naples - Dept. of Agricultural
Sciences

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-6}

\textbf{Presenter:} Joana Retamero Argemí

\textbf{Affiliation:} CREAF

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Plant Traits, Floral Biology, and
Pollination}\label{plant-traits-floral-biology-and-pollination}
...
\textbf{Presenter:} Angie Paola Carvajal Muñoz

\textbf{Affiliation:} Universidad Rey Juan Carlos

\textbf{Authors:} Angie Carvajal-Muñoz, F. Javier Jiménez-López, Stela
Vlajos-Gómez, Luis Navarro-Echeverría, Carlos Lara-Romero \& Martí
March-Salas

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Pollinator ecology and
Networks}\label{pollinator-ecology-and-networks}

\subsubsection{NA}\label{na-7}

\textbf{Presenter:} Agostina Torres

\textbf{Affiliation:} ETH Zürich
...
\textbf{Presenter:} Ana Pérez Pérez

\textbf{Affiliation:} Neobéitar S.L

\textbf{Authors:} Ana Pérez-Pérez, Carlos Hernández-Castellano, María
Benito-Murcia, David Risco , Eduardo J. García-Vicente, María
Martín-Domínguez, Noelia Hermosilla, Roser Velarde, María
Escobar-González, Josep Estruch, Irene Torres-Blas, Emmanuel Serrano
...
\textbf{Presenter:} Ane Navarro-Ayensa

\textbf{Affiliation:} Universidad de Granada

\textbf{Authors:} Ane Navarro-Ayensa, Lea Ada Palao Picotti; Luis
Navarro

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-8}

\textbf{Presenter:} Barbora Jelínková

\textbf{Affiliation:} UJEP - Universita Jana Evangelisty Purkyně,
Fakulta životního prostředí (environmental studies)

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-9}

\textbf{Presenter:} Eduardo José García Vicente

\textbf{Affiliation:} Neobéitar S.L.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-10}

\textbf{Presenter:} Gerard Rigola Coll

\textbf{Affiliation:} CREAF (Centre de Recerca Ecològica i Aplicacions
Forestals)
...
\textbf{Presenter:} Gregorio García Sánchez-Ramal

\textbf{Affiliation:} Universidad de Extremadura

\textbf{Authors:} Gregorio García Sánchez-Ramal, José Luis Pérez Bote,
José María Maya Manzano, Francisco Javier Valtueña Sánchez, Ana Isabel
Ortega Olivencia, Josefa López Martínez, Tomás Rodríguez Riaño

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-11}
...
\subsubsection{NA}\label{na-12}

\textbf{Presenter:} Ignasi Lampreave Farran

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-13}

\textbf{Presenter:} Júlia Batlle-Benaiges

\textbf{Affiliation:} Wildlife Ecology \& Health (WE\&H), Servei
d'Ecopatologia de Fauna Salvatge (SEFaS), Universitat Autònoma de
Barcelona, Cerdanyola del Vallès, Spain

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{NA}\label{na-14}

\textbf{Presenter:} Júlia Coromina

\textbf{Affiliation:} Universitat Autònoma de Barcelona
